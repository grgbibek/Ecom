...
<body>
	...
	<table>
		...
		<td>
		<textarea rows="10" cols="30" name="description">${product.description}</textarea>
		</td>
		</tr>
		<tr>
		<td>
		...
		<td>
		<input type="radio" name="condition" id="conditionChoice1" value="good" ${product.condition == 'good' ? 'checked="checked"' : '' }>
		<label for="conditionChoice1">Good</label>
		<input type="radio" name="condition" id="conditionChoice2" value="new" ${product.condition == 'new' ? 'checked="checked"' : '' }>
